...
public class AccountService {
    ...
    public Account findByAccountNumber(String accountNumber) {
        return accountRepository.findByAccountNumberAndStatus(accountNumber, EntityStatus.ACTIVE)
                .orElseThrow(() -> new IllegalArgumentException("Account not found"));
    }

    public Account findByAccountNumberAndPassword(String accountNumber, String password) {
        Account account = accountRepository.findByAccountNumberAndStatus(accountNumber, EntityStatus.ACTIVE)
                .orElseThrow(() -> new IllegalArgumentException("Account not found"));
